...
export const TECHNICAL_PROFILES = {
  ...
  'Ecoza Rix': BOTANICAL('Azadirachtin', 'Azadirachta indica', 'Wettable Powder (WSP)', 'Light Brown Color Liquid'),
  'MargoShine': BOTANICAL('Neem Oil', 'Azadirachta indica', 'Emulsifiable Concentrate (EC)', 'Light Brown Color Liquid'),
  'MargoRix': BOTANICAL('Neem Oil', 'Azadirachta indica', 'Wettable Powder (WSP)', 'Light Brown Color Liquid'),
  'K-Guard': BOTANICAL('Karanjin', 'Pongamia glabra', 'Emulsifiable Concentrate (EC)', 'Light Brown Color Liquid'),
  'K-Rix': BOTANICAL('Karanjin', 'Pongamia glabra', 'Wettable Powder (WSP)', 'Light Brown Color Liquid'),
  'Spindura Plus': BOTANICAL('Spinosad', 'Saccharopolyspora spinosa', 'Suspension Concentrate (SC)', 'White color liquid'),
  'Spindura Rix': BOTANICAL('Spinosad', 'Saccharopolyspora spinosa', 'Wettable Powder (WSP)', 'White color liquid'),
  ...
  'IGreen SHIELD': MICROBIAL('Bacillus licheniformis, Bacillus amyloliquefaciens, Bacillus subtilis', '≥1 × 10⁹ CFU/g', '≤ 8%', '5.5 - 7.5'),
  'IGreen N': MICROBIAL('Azotobacter chroococcum', '≥1 × 10⁹ CFU/g', '≤ 8%', '5.5 - 7.5'),
  'IGreen P': MICROBIAL('Bacillus megaterium', '≥1 × 10⁹ CFU/g', '≤ 8%', '5.5 - 7.5'),
  'IGreen K': MICROBIAL('Frateuria aurantia', '≥1 × 10⁹ CFU/g', '≤ 8%', '5.5 - 7.5'),
  'IGreen S': MICROBIAL('Thiobacillus thiooxidans', '≥1 × 10⁹ CFU/g', '≤ 8%', '5.5 - 7.5'),
  'IGreen Si': MICROBIAL('Bacillus mucilaginosus', '≥1 × 10⁹ CFU/g', '≤ 8%', '5.5 - 7.5'),
  'IGreen Zn': MICROBIAL('Bacillus aryabhattai', '≥1 × 10⁹ CFU/g', '≤ 8%', '5.5 - 7.5'),
