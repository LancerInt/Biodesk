...
const DOC_FILES = {
  ...
  'MargoRix_COA': require('../assets/documents/MargoRix_COA.pdf'),
  'MargoRix_MSDS': require('../assets/documents/MargoRix_MSDS.pdf'),
  ...
  'Ecoviz_MSDS': require('../assets/documents/Ecoviz_MSDS.pdf'),
  'Ecoviz_COA': require('../assets/documents/Ecoviz_COA.pdf'),
  'Ecoviz_Brochure': require('../assets/documents/Ecoviz_Brochure.pdf'),
