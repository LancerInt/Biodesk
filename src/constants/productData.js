...
export const PORTFOLIO_FAMILIES = [
  ...
  },
  {
    ...
    icon: 'bug-outline',
    color: '#1565C0',
    overview: 'Natural-origin spinosad insecticides for rapid control of thrips and lepidopteran larvae. Available in high-load SC, WSP, and economy SC formulations.',
  ...
  },
  {
    ...
    icon: 'shield-leaf',
    color: '#00695C',
    overview: 'Pongamia-derived karanjin botanicals for antifeedant and contact pest management. Available in EC and WSP formulations.',
  ...
  },
  {
    ...
    icon: 'mushroom',
    color: '#2E7D32',
    overview: 'Trichoderma-based biofungicides for soil-borne disease management. Available as T. asperellum (Zymor) and T. harzianum (Zymor-H).',
  ...
  },
  {
    ...
    icon: 'spa',
    color: '#9C27B0',
    overview: 'Microbial biofertilizer range — broad-spectrum NPK consortium, SHIELD rhizosphere conditioner, plus single-nutrient specialists for Nitrogen, Phosphorus, Potassium, Sulfur, Silicon, and Zinc.',
...
const PACK_SIZES = {
  ...
  'Zymor': ['500 g', '1 kg', '25 kg'], 'Zymor-H': ['500 g', '1 kg', '25 kg'],
  'Seira': ['500 g', '1 kg', '25 kg'],
  'EnCilo': ['500 g', '1 kg', '25 kg'], 'Rhiota': ['500 g', '1 kg', '25 kg'],
  'Neuvita': ['500 g', '1 kg', '25 kg'],
  'Elixora': ['500 g', '1 kg', '25 kg'], 'Ecoviz': ['500 g', '1 kg', '25 kg'],
  ...
  'IGreen K': ['500 g', '1 kg', '25 kg'], 'IGreen S': ['500 g', '1 kg', '25 kg'],
  'IGreen Si': ['500 g', '1 kg', '25 kg'], 'IGreen Zn': ['500 g', '1 kg', '25 kg'],
...
const TARGET_CROPS = {
  ...
  'Zymor': ['Rice', 'Wheat', 'Maize', 'Cotton', 'Tomato', 'Chilli', 'Brinjal', 'Onion', 'Banana', 'Grapes', 'Citrus', 'Mango', 'Tea', 'Coffee', 'Sugarcane', 'Pulses', 'Oilseeds', 'Floriculture crops', 'Nursery crops'],
  'Zymor-H': ['Rice', 'Wheat', 'Maize', 'Cotton', 'Tomato', 'Chilli', 'Brinjal', 'Onion', 'Banana', 'Grapes', 'Citrus', 'Mango', 'Tea', 'Coffee', 'Sugarcane', 'Pulses', 'Oilseeds', 'Floriculture crops', 'Nursery crops'],
  ...
  'Rhiota': ['Rice', 'Wheat', 'Maize', 'Cotton', 'Tomato', 'Chilli', 'Brinjal', 'Onion', 'Banana', 'Grapes', 'Citrus', 'Mango', 'Tea', 'Coffee', 'Sugarcane', 'Pulses', 'Oilseeds', 'Floriculture crops', 'Nursery crops'],
  ...
  'Ecoviz': ['Cotton', 'Tomato', 'Chilli', 'Brinjal', 'Okra', 'Cabbage', 'Cauliflower', 'Grapes', 'Pomegranate', 'Citrus', 'Mango', 'Banana', 'Tea', 'Coffee', 'Pulses', 'Oilseeds', 'Floriculture crops', 'Nursery crops'],
  ...
  'IGreen N': ['Rice', 'Wheat', 'Maize', 'Cotton', 'Sugarcane', 'Pulses', 'Oilseeds', 'Vegetables', 'Fruit crops', 'Floriculture crops'],
  'IGreen P': ['Rice', 'Wheat', 'Maize', 'Cotton', 'Sugarcane', 'Pulses', 'Oilseeds', 'Vegetables', 'Fruit crops', 'Floriculture crops'],
  'IGreen K': ['Rice', 'Wheat', 'Maize', 'Cotton', 'Sugarcane', 'Banana', 'Grapes', 'Citrus', 'Mango', 'Vegetables', 'Fruit crops', 'Floriculture crops'],
  'IGreen S': ['Oilseeds', 'Pulses', 'Cotton', 'Onion', 'Garlic', 'Cabbage', 'Cauliflower', 'Mustard', 'Groundnut', 'Sugarcane'],
  'IGreen Si': ['Rice', 'Wheat', 'Sugarcane', 'Maize', 'Tomato', 'Cucumber', 'Grapes', 'Banana', 'Floriculture crops', 'Nursery crops'],
  'IGreen Zn': ['Rice', 'Wheat', 'Maize', 'Cotton', 'Sugarcane', 'Citrus', 'Banana', 'Mango', 'Vegetables', 'Pulses'],
  'Mystica': ['All Crops'],
  'Engrow': ['All Crops'],
  'Maxineem': ['All Crops'],
  'K-Mix': ['All Crops'],
...
const ID_MAP = {
  ...
  'Mycova': 'mp-001', 'Rexora': 'mp-002', 'Zymor': 'mp-003', 'Zymor-H': 'mp-004',
  'Seira': 'mp-006', 'EnCilo': 'mp-007', 'Rhiota': 'mp-008', 'Elixora': 'mp-009',
  'Ecoviz': 'mp-010', 'Neuvita': 'mp-011',
  'Zenita': 'bs-001', 'Cropsia': 'bs-002', 'Blooma': 'bs-003',
  'EnRhize': 'bs-004', 'Envicta': 'bs-005', 'Orgocare': 'bs-006',
  'IGreen NPK': 'bf-001', 'IGreen SHIELD': 'bf-002',
  'IGreen N': 'bf-003', 'IGreen P': 'bf-004', 'IGreen K': 'bf-005',
  'IGreen S': 'bf-006', 'IGreen Si': 'bf-007', 'IGreen Zn': 'bf-008',
