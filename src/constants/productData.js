...
export const PORTFOLIO_FAMILIES = [
  ...
  },
  {
    ...
    icon: 'mushroom',
    color: '#2E7D32',
    overview: 'Trichoderma-based biofungicides for soil-borne disease management. Available as T. asperellum (Biota) and T. harzianum (Biota-H).',
...
const PACK_SIZES = {
  ...
  'Biota': ['500 g', '1 kg', '25 kg'], 'Biota-H': ['500 g', '1 kg', '25 kg'],
...
const TARGET_CROPS = {
  ...
  'Biota': ['Rice', 'Wheat', 'Maize', 'Cotton', 'Tomato', 'Chilli', 'Brinjal', 'Onion', 'Banana', 'Grapes', 'Citrus', 'Mango', 'Tea', 'Coffee', 'Sugarcane', 'Pulses', 'Oilseeds', 'Floriculture crops', 'Nursery crops'],
...
const ID_MAP = {
  ...
  'Mycova': 'mp-001', 'Rexora': 'mp-002', 'Biota': 'mp-003', 'Biota-H': 'mp-004',
  'Seira': 'mp-006', 'EnCilo': 'mp-007', 'Subtilix': 'mp-008', 'Elixora': 'mp-009',
