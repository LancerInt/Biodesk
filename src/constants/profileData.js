...
export const PROFILE_SECTIONS = [
  ...
  },
  {
    ...
    content: {
      ...
      regions: [
        { name: 'USA', status: 'Established', partners: [
          { company: 'Biosafe', country: 'USA' },
          { company: 'Atticus', country: 'North Carolina, USA' },
          { company: 'Horizon Bioagro S.A.', country: 'Costa Rica, USA' },
          { company: 'MGK', country: 'Minneapolis, USA' },
          { company: 'Aanika', country: 'USA' },
          { company: 'Bioworks', country: 'USA' },
          { company: 'Sepro', country: 'USA' },
          { company: 'SymAgro', country: 'USA' },
          { company: 'InsectaPel', country: 'South Carolina' },
        ]},
        { name: 'Latin America', status: 'Emerging', partners: [
          { company: 'Biotrop', country: 'Brazil' },
          { company: 'Aqua Do Brasil', country: 'Brazil' },
          { company: 'FAITE - Rayard Khan', country: 'Trinidad & Tobago' },
          { company: 'Microtek', country: 'Ecuador' },
          { company: 'Disagro - Salomon', country: 'Guatemala' },
          { company: 'PTI', country: 'Mexico' },
          { company: 'SemiAgro', country: 'Panama' },
          { company: 'Technica Agricola', country: 'Panama' },
          { company: 'Innova Agro', country: 'Peru' },
          { company: 'Nexxt', country: 'Peru' },
          { company: 'Montana', country: 'Peru' },
          { company: 'Agro Advice - Vanessa', country: 'Peru' },
          { company: 'Alteo - Victor', country: 'Colombia' },
          { company: 'Segetis', country: 'Colombia' },
          { company: 'ABC Biocontrollers', country: 'Panama' },
        ]},
        { name: 'Africa', status: 'Expanding', partners: [
          { company: 'Osho', country: 'Kenya' },
          { company: 'Osho', country: 'Uganda' },
          { company: 'Osho', country: 'Zambia' },
          { company: 'Osho', country: 'Togo' },
          { company: 'Glover', country: 'Ghana' },
          { company: 'EAD Egypt - Mahrous', country: 'Egypt' },
          { company: 'European Group for Agriculture Development - Alaa', country: 'Egypt' },
          { company: 'Growtech', country: 'Egypt' },
          { company: 'EMC - Kandji', country: 'Senegal' },
          { company: 'DVA', country: 'Morocco' },
        ]},
        { name: 'Middle East', status: 'Established', partners: [
          { company: 'ESNAD', country: 'Dubai' },
          { company: 'Haya Alkhethra Agricultural Laboratory L.L.C', country: 'Iran' },
          { company: 'ekolojik Tarim', country: 'Turkey' },
        ]},
        { name: 'Southeast Asia', status: 'Growing', partners: [
          { company: 'Haithuy', country: 'Vietnam' },
          { company: 'Zaldy', country: 'Philippines' },
          { company: 'Kingbo', country: 'China' },
          { company: 'Saki', country: 'Indonesia' },
          { company: 'Korea Bio', country: 'South Korea' },
          { company: 'DTW', country: 'Sri Lanka' },
        ]},
        { name: 'South Asia', status: 'Established', partners: [
          { company: 'DTW', country: 'Sri Lanka' },
        ]},
        { name: 'Europe', status: 'Emerging', partners: [
          { company: 'Greenhof', country: 'Germany' },
          { company: 'Veganic', country: 'Spain' },
          { company: 'Nacho', country: 'Spain' },
          { company: 'Omex - Oskar', country: 'UK' },
          { company: 'Ausoil', country: 'Australia' },
        ]},
      ],
      stats: [
