...
const PRODUCTS = [
  ...
  { id: 'prod_k_rix', brandName: 'K-Rix', activeIngredient: 'Karanjin (WSP)', categoryId: 'cat_botanical_pesticide', icon: 'shield-leaf-outline' },
  ...
  { id: 'prod_ecoviz', brandName: 'Ecoviz', activeIngredient: 'Isaria fumosorosea', categoryId: 'cat_microbial_pesticide', icon: 'mushroom' },
  // Biostimulants
